...
# For larger plots
#
opts_chunk$set(fig.width=20,fig.height=20,message=FALSE,echo=FALSE,warning=FALSE)
myTheme <- theme_grey()
...
createRouteMap(loc='Nashville, TN',subset(df,name %in% sample(routes$name,100)))
```
