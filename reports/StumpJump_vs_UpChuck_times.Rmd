...
again to UltraSignup) I created a very simple prediction model with a
...
see what a real statistician can do with this data, check out Dr. Chris
Fonnesbeck's analysis for something a little more stringent (much
...
Facebook page if you want to add to the discussion.
